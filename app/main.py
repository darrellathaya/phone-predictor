...
MODEL_PATH = os.path.join(BASE_DIR, "..", "models", "price_range_model.pkl")
ENCODER_PATH = os.path.join(BASE_DIR, "..", "models", "chipset_encoder.pkl")
...
>>>>>>> d3388dac3546289dededcee8c370eb235c69cc75
